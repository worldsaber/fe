<template>
	<div class="container">
		...
		<div class="wrapper">
			...
			<p class="explian">Please enter the Transaction Code which M-pesa sent to your Mobile Phone via SMS, e.g. MDI3WSXXXX. </p>
			...
			<section>
				...
				<ul>
					...
					<li>M-Pesa Paybill was used to Deposit, but no records exist;</li>
				</ul>
				<p class="all">In all of these situations, you might still have received an SMS from M-Pesa Paybill informing that this transaction was successful.</p>
			</section>
		</div>
	</div>	
</template>
