...
const detailData = {
	...
	data: {
		...
		counterAuthority: '11',
		counterIconUrl: '/11',
		payChTxId: 'transaction 111111111',
		comment: 'Due to bet rollback, your bet winnings have been deducted by SportyBet. In the case of a winning bet, the winnings of your bet will be refunded to your account.',
		rollbackDetail: {
			gameId: 'id1111111',
			rollbackTime: '1513316027699',
			home: 'HOME Team 1',
			away: 'AWAY Team 1',
			market: 'x',
			selection: '1',
...
/*
	获取交易记录
 */
mockjax.get('/pocket/v1/statements', a);
mockjax.get('/pocket/v1/statements/', detailData);
