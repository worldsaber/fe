		...
		<div slot="mid">
			<div>
				...
				<div class="main-body">
					...
					<div class="plans">
						<div class="plan-item"  v-for="(content,index) in contents" :key="index">
								...
								<div class="cell-wrap" v-if="expandStatus[content.plan]">
									<div class="cell" v-for="(detail,index) in content.details" :key="index">
										...
										<div v-if="Array.isArray(detail[1])" class="detail-item-wrap">
											<div v-for="(item, idx) in detail[1]" class="detail-item" :key="`${index}-${idx}`"><i class="icon"></i><span>{{item}}</span></div>
										</div>
...
export default {
	...
	created () {
		...
		this.contents = [{
			...
			amount: 5,
			details: [
					['1st Day', `1 x ${this.currency} 0.2`],
					['2nd Day', `1 x ${this.currency} 0.2`],
					['4th Day', `1 x ${this.currency} 0.2`],
					['6th Day', `1 x ${this.currency} 0.1`],
					['7th Day', `1 x ${this.currency} 0.3`],
			],
			day: 7
		},
		{
			...
			amount: 10,
			details: [
					['1st Day', `2 x ${this.currency} 0.2`],
					['2nd Day', `2 x ${this.currency} 0.5`],
					['4th Day', `2 x ${this.currency} 0.4`],
					['6th Day', `2 x ${this.currency} 0.8`],
					['7th Day', `2 x ${this.currency} 0.6`],
			],
			day: 7
		},
		{
			...
			details: [
					['1st Day', `2 x ${this.currency} 0.2`],
					['2nd Day', `2 x ${this.currency} 1`],
					['4th Day', `2 x ${this.currency} 0.5`],
					['6th Day', `2 x ${this.currency} 1.8`],
					['7th Day', `2 x ${this.currency} 2`],
			],
			day: 7
		},
		{
			...
			amount: 12,
			details: [
					['1st Day', `2 x ${this.currency} 1`],
					['2nd Day', `2 x ${this.currency} 5`],
					['4th Day', `2 x ${this.currency} 5`],
					['6th Day', `2 x ${this.currency} 5`],
					['7th Day', `2 x ${this.currency} 8`],
					['9th Day', `2 x ${this.currency} 6`],
			],
			day: 9
		}, {
			plan: 'E',
			...
			amount: 12,
			details: [
					['1st Day', `2 x ${this.currency} 3`],
					['2nd Day', `2 x ${this.currency} 10`],
					['4th Day', `2 x ${this.currency} 12`],
					['6th Day', `2 x ${this.currency} 20`],
					['7th Day', `2 x ${this.currency} 10`],
					['9th Day', `2 x ${this.currency} 20`],
			],
			day: 9
		}
		];
