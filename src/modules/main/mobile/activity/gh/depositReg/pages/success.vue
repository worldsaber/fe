<template>
	<div class="deposit-reg-success-wrap">
		...
		<div class="success-content">{{showCurrencyOrigin}} {{giftsNumber}} Gifts!</div>
		<a class="success-deposit-btn" :href="depositUrl">Deposit {{amount}}</a>
		<div class="success-deposit-gifts">You'll get {{showCurrencyOrigin}} {{giftsNumber}} OFF in total when placing bets at SportyBet!</div>
