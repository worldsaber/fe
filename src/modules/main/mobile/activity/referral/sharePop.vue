...
export default {
	...
	created () {
		this.invitation = `Hi! Have you heard of SportyBet?! It's a whole new concept at Betting! Follow me and give it a try! UP to ${this.showCurrency} 1000 Discount gifts on first deposit! Check https://www.sportybet.com/registration?referralCode=${this.referralCode} or Send an SMS with "${this.referralCode}" to 29123.`;
	...
	methods: {
		copyLink () {
			...
			const text = `Hi! Have you heard of SportyBet?! It\'s a whole new concept at Betting! Follow me and give it a try! UP to ${this.showCurrency} 1000 Discount gifts on first deposit! Check https://www.sportybet.com/registration?referralCode=${referralCode} or Send an SMS with "${referralCode}" to 29123.`;
