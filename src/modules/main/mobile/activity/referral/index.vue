			...
			<div style="overflow: hidden;">
				...
				<div class="main" v-if="showReferrals === false">
					<div class="total-gifts">
						...
						<span class="banner"><span style="margin-left:-25px;">YOU GOT A TOTAL OF</span><br>{{showCurrency}}<span style="font-size: 21px;">{{totalGiftAmount}}</span> IN DISCOUNT GIFTS</span>
					...
					<div class="tabs" v-if="status!==40">
						...
						<div class="contentA" v-if="option2">
							...
							<p class="detail" style="margin-top:25px;margin-bottom:25px">A. Let your friend register using our PC/Wap/App versions of SportyBet, and fill in the "Referral Code" field with your code. (Please, remind your friend to click"Apply")</p>
							<div class="example1"></div>
							<p class="detail" style="margin-top:32px;margin-bottom:34px ">B. Tell your friends to send an SMS with your Referral Code (R****** )  to 29123.</p>
							<div class="example2"></div>
							<p class="detail" style="margin-top:58px;padding-bottom:35px "><strong class="num">3.</strong>After your friend made Settled Stakes in a Total value of {{showCurrency}}1,000 or above, SportyBet will credit both of the participants' accounts. Gifts can be viewed by going to <a @click.prevent="jmpGifts" style="text-decoration: underline;color: #2d6ee3;">"Gifts".</a></p>
						</div>
						<div class="contentB" v-if="option1">
							...
							<p class="detail" style="padding-bottom:31px"><strong class="num">2.</strong>After your friend made Settled Stakes in a Total value of {{showCurrency}}1,000 or above, SportyBet will credit both of the participants' accounts. Gifts can be viewed by going to <a @click.prevent="jmpGifts" style="text-decoration: underline;color: #2d6ee3;">"Gifts".</a></p>
						</div>
					</div>
...
export default {
	...
	created () {
		...
		this.invitation = `Hi! Have you heard of SportyBet?! It\'s a whole new concept at Betting! Follow me and give it a try! Check http://www.sportybet.com/registration?referralCode=${this.referralCode} or Send an SMS with "${this.referralCode}" to 29123.`;
