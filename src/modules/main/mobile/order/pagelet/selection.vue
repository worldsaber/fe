	...
	<div class="ticket-selection-list">
		<div class="seperate">
			...
			<div class="solo">
				...
				<div class="to-live" v-if="(selection.eventStatus == 1|| selection.eventStatus == 2) && isHaveLiveLink" @click="toLive(selection.eventId,selection.specifier)">Go to Live Betting{{(!commentNum || commentNum === 0) ? '' : ` (Chat ${commentNum})`}}
					<i class="arrow"></i>
				</div>
		</div>
		</div>
