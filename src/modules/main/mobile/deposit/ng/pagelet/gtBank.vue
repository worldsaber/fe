<template>
	<div class="gt-bank-wrap">
		<div class="bank-title">
			<img class="bank-icon" src='../img/gtbank.png' />GTBank
		</div>
...
export default {
	data() {
		...
		return {
			...
			currentTab: '',
			phone,
			transactionLink: userCenterUrl.transaction
		};
	},
	computed: {
		isWebsite() {
...
.gt-bank-wrap{
	...
	.bank-title{
		font-size: 14/@rem;
		color: #000000;
		margin: 10/@rem 0 6/@rem;
		.bank-icon{
			width: 24/@rem;
			margin: 10/@rem 10/@rem 10/@rem 16/@rem;
		}
	}
	.visit-link{
		display: block;
