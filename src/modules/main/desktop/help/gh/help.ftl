...
<div class="m-main-info">
	<div class="m-content faq">
		<#include 'packages/fe-help/gh/pc/how-to-play/faq/index.ftl'>
	</div>

	<div class="m-content sports">
		<#include 'packages/fe-help/gh/pc/how-to-play/sports/index.ftl'>
	</div>

	<div class="m-content live-betting">
		<div class="m-content-wrap">
		<#include 'packages/fe-help/gh/pc/how-to-play/live-betting.ftl'>
		</div>
	</div>

	<div class="m-content games">
		<#include 'packages/fe-help/gh/pc/how-to-play/games/index.ftl'>
	</div>

	<div class="m-content virtuals">
		<#include 'packages/fe-help/gh/pc/how-to-play/virtuals/index.ftl'>
	</div>

	<div class="m-content jackpot">
		<div class="m-content-wrap">
		<#include 'packages/fe-help/gh/pc/how-to-play/jackpot.ftl'>
		</div>
	</div>

	<div class="m-content others">
		<#include 'packages/fe-help/gh/pc/how-to-play/others/index.ftl'>
	</div>

	<div class="m-content about-us">
		<div class="m-content-wrap">
		<#include 'packages/fe-help/gh/pc/about/about-us.ftl'>
		</div>
	</div>

	<div class="m-content terms-and-conditions">
		<#include 'packages/fe-help/gh/pc/about/terms-and-conditions/index.ftl'>
		<div class="m-match-tips">
		<#include 'packages/fe-help/gh/pc/about/terms-and-conditions/_effect-time.ftl'>
		</div>
	</div>

	<div class="m-content responsible-gaming">
		<#include 'packages/fe-help/gh/pc/about/responsible-gaming/index.ftl'>
	</div>

	<div class="m-content privacy-policy">
		<#include 'packages/fe-help/gh/pc/about/privacy-policy/index.ftl'>
	</div>
</div>
