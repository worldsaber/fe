...
export function getErrorTips(retData) {
	...
	case 62100:
		return {
			title: '',
			type: 'dialog',
			msg: message || `Maximum Daily Transaction Value is ${getShowCurrency()}${formatNumber(wdMax, 2)}. The maximum you can send in a day is ${getShowCurrency()}${formatNumber(wdMax, 2)}.`
		};
	case 64001:
	case 64002:
		return {
