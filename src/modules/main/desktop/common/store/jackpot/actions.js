			...
			getData('/orders/order', {
				...
				case 4200:
					commit(mutationTypes.SET_ORDER_DATA, {
						...
						msg: res.message || 'Your account balance is insufficient, please deposite some money first then place a bet again. Sorry for this inconvience.',
						optType: 'deposit',
						buttonList: ['Cancel', '*Deposit'],
					});
					break;
				// 红包生单失败
				case 4210:
