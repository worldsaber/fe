export const helpTips = [
	...
	},
	{
		...
		content: {
			list: [
				'Customers are unable to Cashout a bet in which a Gift was used. Gifts must always be used in the Betslip when placing a bet. ',
				'They substitute part of the amount the customer would have to spend.',
			]
		},
		type: 'list'
	}
