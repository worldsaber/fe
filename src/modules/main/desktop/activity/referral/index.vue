		...
		<div class="highlight">
		  <div class="banner">
			  ...
			  <div class="got-gifts">
				  ...
				  <div class="gifts">
					  {{showCurrency}}<span style="font-size:43.5px">{{totalGiftAmount}}</span> IN DISCOUNT GIFTS.
				  </div>
			  </div>
			...
			<div class="tabs">
				...
				<div class="rules-wrapperA" v-if="option2">
					...
					<div class="rule-wrapper">
						...
						<div class="details">
							<p class="rule" style="margin-left:95px; display:inline-table">1. Let your friend register using our PC/Wap/<br>App versions of SportyBet, and fill in the "Referral<br>Code" field with your code. (Please, remind your<br> friend to click "Apply")</p>
							<span class="rule" style="margin-left:53px;display:inline-table;vertical-align:top;">2. Tell your friends to send an SMS with your<br>Referral Code (R****** )  to 29123.</span>
					...
					<div class="rule-wrapper">
						...
						<span class="rule" style="display:inline-block">After your friend made Settled Stakes in a Total value of {{showCurrency}}1,000 or above, SportyBet will<br>credit both of the participants' accounts. Gifts can be viewed by going to <a :href="gift" style="text-decoration: underline;color: #2d6ee3;">"Gifts".</a></span>
					</div>
				</div>
				<div class="rules-wrapperB" v-if="option1">
					<div class="rule-wrapper" style="margin-top:62px">
						...
						<div class="copy-con">Hi! Have you heard of SportyBet?! It's a whole new concept at Betting! Follow me and give it a try! Check http://www.sportybet.com/registration?referralCode={{referralCode}} or Send an SMS with "{{referralCode}}" to 29123.</div>
					</div>
					...
					<div class="rule-wrapper" style="margin-top:52px;">
						...
						<span class="rule" style="display:table-cell;vertical-align:middle">After your friend made Settled Stakes in a Total value of {{showCurrency}}1,000 or above, SportyBet will credit both of the participants' accounts. Gifts can be viewed by going to  <a :href="gift" style="text-decoration: underline;color: #2d6ee3;">"Gifts".</a></span>
					</div>
				</div>
			</div>
		</div>
...
export default {
	...
	created () {
		this.text = `Hi! Have you heard of SportyBet?! It's a whole new concept at Betting! Follow me and give it a try! Check http://www.sportybet.com/registration?referralCode=${this.referralCode} or Send an SMS with "${this.referralCode}" to 29123.`;
		this.details = [
			...
			`3. Once the newly referred customer meets the Stake Conditions (A, B and C) to obtain a "Cash Gift",
				a "Cash Gift" of ${this.showCurrency} 50 will automatically be credited to the newly referred customer and a "Discount Gift" of ${this.showCurrency}150 will be credited to the referrer’s account.`,
		...
		this.requirements = [
			{ con: `A newly referred customer at SportyBet must place a total amount of Stakes with all Odds of 2.0 or above which account for a total of ${this.showCurrency}1,000 or more (can be placed at different times).`, index: 'A.' },
