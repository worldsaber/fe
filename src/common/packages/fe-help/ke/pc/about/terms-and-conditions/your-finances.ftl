<div class="help-content-wrap"><h3 id="c-your-finances">C. YOUR FINANCES</h3>
<ol>
<li><p>Deposits and Bets</p>
...
<p>1.4 You agree that we shall be entitled to retain any interest which might accrue on monies held in your SportyBet account.</p>
<p>1.5 No credit will be offered by any employee of SportyBet, and all bets must be supported by sufficient funds in the customer account. SportyBet reserves the right to void any bet which may have inadvertently been accepted when the account did not have sufficient funds to cover the bet. Should funds be credited to a customer&#39;s account in error it is the customer&#39;s responsibility to inform SportyBet without delay. SportyBet will recover such funds by account adjustment.</p>
<p>1.6 Unless otherwise stated, all examples given on the Website are given in KES. For any transaction which requires a currency exchange, the applicable exchange rate will be the mid-rate as quoted by the Financial Times. The currency options available are listed in Appendix One to these Terms and Conditions and on the Website.</p>
...
<p>1.8 SportyBet shall be entitled to withhold and/or retain any and all amounts earned or received by you as a result of or in connection with your ‘unauthorised’ use of the Website including activities which are not for an authorised purpose.</p>
</li>
<li><p>Withdrawals</p>
...
<p>2.3 If the value of a deposit is not played through in full before a withdrawal is requested, SportyBet reserves the right to make a charge to the customer’s account to cover all reasonable costs relating to both the deposit and withdrawal. If necessary, the value of the withdrawal requested may be reduced accordingly.</p>
</li>
<li><p>Other</p>
...
<p>3.2 We may, at any time, set off any positive balance on your account against any amounts owed by you to SportyBet or any company within the SportyBet group.</p>
