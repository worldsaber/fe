<div class="help-content-wrap"><h3 id="appendix-two">Appendix Two</h3>
<h4 id="betting-provisions">BETTING PROVISIONS</h4>
<h5 id="sports-and-special-event-betting">Sports and Special Event Betting</h5>
...
<h5 id="minimum-bets-amount">Minimum bets amount</h5>
<p>The minimum bets amount for each order is the relevant value defined below based on the currency of the user’s account:-KES 50.</p>
<h5 id="maximum-winnings">Maximum Winnings</h5>
<p>The maximum winnings for each bet is the relevant value defined below based on the currency of the user’s account:-KES 1,000,000.</p>
<h5 id="related-contingency-betting">Related Contingency Betting</h5>
...
<p>For example, in a soccer match involving Arsenal and Everton:</p>
<p>If the odds for Manchester United to win at home against Tottenham are 2.00 and the correct score odds for Manchester United to win 1-0 is 8.00, by having the multiple bet of Manchester United to win and the correct score to be 1-0, a customer would be getting 16.00 for an bet that should have odds of 8.00, as if Manchester United win 1-0 they would automatically have won the match.</p>
...
<p>Nadal to win the semi-final of Wimbledon; and</p>
<p>Nadal to win the Wimbledon tournament outright.</p>
...
<p>Formosa to win the 2000 Guineas; and</p>
<p>Formosa to win the Derby.</p>
<p>As the odds for Formosa to win the Derby depend on whether she wins the 2000 Guineas, the odds for her to win the Derby at the time the bet was struck cannot be used to calculate the multiple bet. A special price to win both races will be quoted instead.</p>
<p>In the case of all multiples including selections with related outcomes, if a bet is taken inadvertently SportyBet reserves the right to void part of or the whole of the bet.</p>
</div>