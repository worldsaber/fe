...
<p>1.6 Unless otherwise stated, all examples given on the Website are given in GHS. For any transaction which requires a currency exchange, the applicable exchange rate will be the mid-rate as quoted by the Financial Times. The currency options available are listed in Appendix One to these Terms and Conditions and on the Website.</p>
