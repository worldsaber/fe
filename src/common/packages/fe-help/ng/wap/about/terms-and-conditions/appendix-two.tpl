...
<p>The minimum bets amount for each order is the relevant value defined below based on the currency of the user’s account: NGN 100.</p>
<h5 id="maximum-winnings">Maximum Winnings</h5>
<p>The maximum winnings for each bet is the relevant value defined below based on the currency of the user’s account: NGN 4,000,000.</p>
