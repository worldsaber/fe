...
window.child = child;
var Content = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"inner",attrs:{"data-test":"1111"}},[_vm._v("我是demo2，我的内容是一个单vue文件，数据是从属性 contentData属性获取"),_c('br'),_vm._v(_vm._s(_vm.ccc)+_vm._s(_vm.dialogData.cjx.cjx)+" "+_vm._s(_vm.dialogData.test)),_c('child',[_vm._v("test")]),_c('button',{on:{"click":_vm.changeT}},[_vm._v("修改test")]),_c('br'),_c('button',{on:{"click":_vm.ff}},[_vm._v("修改cjx")])],1)},staticRenderFns: [],
	data: function data () {
		return {
			ccc: 'ccc'
		};
...
var Input = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0)},staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"input-test"},[_c('input',{attrs:{"type":"text","name":"test"}}),_c('textarea',{attrs:{"rows":"","cols":""}},[_vm._v("我是test")])])}],
	methods: {
		ff: function ff () {
...
var demo$1 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v("dialog demo"),_c('br'),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo1}},[_vm._v("打开一个普通弹窗")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo2}},[_vm._v("弹窗内容是 .Vue单文件")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo3}},[_vm._v("弹窗内容是 {template: \"...\"}")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo4}},[_vm._v("弹窗内容是 {render: () => {}}")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo4_1}},[_vm._v("弹窗内容是 Vnode")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo5}},[_vm._v("弹窗值传递")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo6}},[_vm._v("修改弹窗内容")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo7}},[_vm._v("修改弹窗title")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo8}},[_vm._v("修改dialog高度，宽度，位置")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo9}},[_vm._v("打开多个非模态窗口")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo10}},[_vm._v("打开多个模态窗口")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo11}},[_vm._v("动画设置")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo12}},[_vm._v("dialog事件演示")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo13}},[_vm._v("dialog全局设置")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo14}},[_vm._v("dialog自动关闭")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo15}},[_vm._v("dialog alert接口")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo16}},[_vm._v("dialog confirm接口")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo17}},[_vm._v("dialog toast接口")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo18}},[_vm._v("自定义动画")]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":_vm.demo19}},[_vm._v("input框测试")]),_c('div',{attrs:{"id":"console"}}),_c('ul',_vm._l((50),function(n){return _c('li',[_vm._v("列表测试"+_vm._s(n)+"-"+_vm._s(Math.random()))])}))])},staticRenderFns: [],
	data: function data () {
		return {
			css: [{
				test: true,
